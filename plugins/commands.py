...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('Uᴘᴅᴀᴛᴇs 🤖', url='https://t.me/+-zWqPVQugPE1OTE1')
            ],
            [
                InlineKeyboardButton('🚨 Sᴜᴘᴘᴏʀᴛ', url='https://t.me/+qSOd_xaMbwE2YzU1'),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🚨 Sᴜᴘᴘᴏʀᴛ', url='https://t.me/+-zWqPVQugPE1OTE1'),
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇs 🤖', url='https://t.me/+qSOd_xaMbwE2YzU1')
        ], [
